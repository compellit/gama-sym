...
from preprocessing.norm import normconfig as tc
...
class EdManager:
    ...
    def accent_check(self, cand_form, oov_form):
        # Cases like comío (OOV) to comido
    ...
    def find_cost(self, a, b):
        ...
        if a == b:
            ...
            try:
                ...
                #    print("KeyError, a: %s, b: %s || Bad Key: %s" % (a, b, msg))
                cost = -1
...
class EdScoreMatrix:
    ...
    #   for Galician, can't include ñ and ç unlike for Spanish tweet normalization, cos
    #   we need deletion cost for some diacritic to be low (ç=>z, ñ=>n)
    #accented_chars = ['á', 'é', 'í', 'ñ', 'ó', 'ú', 'ç'] # Spanish tweets
